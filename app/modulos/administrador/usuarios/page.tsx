...
export default function Usuarios() {
    ...
    const roleNames = ["Sin rol", "Administrador", "Gerencia", "Ordenes", "Inventario"];
    ...
    return (
        <main className="flex flex-col justify-between p-6 mt-8">
                            ...
                            {users.map(user => (
                                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">                                    
                                    <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                        <img className="w-10 h-10 rounded-full" src={user.avatarImg || '/profiles/profile_02.jpeg'} alt={`${user.name} avatar`} />
                                        <div className="ps-3">
