    ...
    return (
        <div className="w-full p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-lg m-auto">
                <div>
                    {user.avatarImg == null ? <div className="block h-40 w-40 m-auto mb-6">
                        <div className="h-40 w-40 bg-red-400 rounded-full text-white p-4 m-auto absolute">
                ...
                <div className="w-full flex">
                    ...
                    <div className="w-full ml-4">
                        ...
                        <div className="mt-2">
                            <select {...register('gender')} id="genero" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div className="w-full flex">
                    ...
                    <div className="w-1/2 ml-2">
                        ...
                        <div className="mt-2">
                            <select {...register('role')} id="role" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
